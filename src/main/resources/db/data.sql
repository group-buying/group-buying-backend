...
insert into board(category_id, title, organizer_id, content, img, event_id, status_code, views, recommend, created_at) values(3, '삼각김밥 1+1 같이 사실분?', 1, '서면 1번출구 편의점에서 삼각김밥 같이 사실분 구합니다. 직거래 우선이요', null, 1, 200, 50, 0, now());
insert into board(category_id, title, organizer_id, content, img, event_id, status_code, views, recommend, created_at) values(3, '편의점 할인 행사 같이 사실분', 1, '서면 1번출구 편의점에서 같이 사실분 구합니다. 직거래 우선이요', null, 2, 200, 50, 0, now());
