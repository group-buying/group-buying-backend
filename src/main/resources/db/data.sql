...
insert into status_code(status_number, type, status, created_at) values(100, 'user', '활성화', now());
insert into status_code(status_number, type, status, created_at) values(101, 'user', '휴면', now());
insert into status_code(status_number, type, status, created_at) values(102, 'user', '탈퇴', now());
insert into status_code(status_number, type, status, created_at) values(200, 'board', '진행중', now());
insert into status_code(status_number, type, status, created_at) values(201, 'board', '거래완료', now());
insert into status_code(status_number, type, status, created_at) values(202, 'board', '마감', now());
insert into status_code(status_number, type, status, created_at) values(203, 'board', '삭제', now());
insert into status_code(status_number, type, status, created_at) values(300, 'participant', '참가', now());
insert into status_code(status_number, type, status, created_at) values(301, 'participant', '미채택', now());
insert into status_code(status_number, type, status, created_at) values(302, 'participant', '채택', now());
insert into status_code(status_number, type, status, created_at) values(303, 'participant', '참가 취소', now());
insert into status_code(status_number, type, status, created_at) values(400, 'payment', '결제완료', now());
insert into status_code(status_number, type, status, created_at) values(401, 'payment', '구매확정', now());
insert into status_code(status_number, type, status, created_at) values(500, 'chatroom', '활성화', now());
insert into status_code(status_number, type, status, created_at) values(501, 'chatroom', '비활성화', now());
insert into status_code(status_number, type, status, created_at) values(502, 'chatroom', '삭제', now());
insert into status_code(status_number, type, status, created_at) values(600, 'report', '대기', now());
insert into status_code(status_number, type, status, created_at) values(601, 'report', '처리중', now());
insert into status_code(status_number, type, status, created_at) values(602, 'report', '처리완료', now());
insert into status_code(status_number, type, status, created_at) values(700, 'chatter_list', '참가', now());
insert into status_code(status_number, type, status, created_at) values(701, 'chatter_list', '나감', now());
insert into status_code(status_number, type, status, created_at) values(702, 'chatter_list', '강퇴당함', now());
